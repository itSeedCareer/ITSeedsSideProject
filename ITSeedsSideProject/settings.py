"""
Django settings for ITSeedsSideProject project.
...
SECRET_KEY = '*0rft$l$&5=wo@@#advy8ltt!_vlzmsj@#zrvxxwqz6q-&p^97'
...
ROOT_URLCONF = 'ITSeedsSideProject.urls'
...
WSGI_APPLICATION = 'ITSeedsSideProject.wsgi.application'
